         ...
         <div class="row">
            <div class="panel panel-default text-left rSide">
               <div class="panel-heading" id="panel-heading-tweet">
                  <a class="authorTweet"><strong>Toni Buzov</strong> <label class="timeTweet">@tonibuzov - 25 min</label></a>
                  <p class="textOfTweet">Dobar dan svima, danas sam kupio ovog ljepotana.</p>
               </div>
               <div class="panel-body panel-body-tweet">
                  <img src="http://www.motorward.com/wp-content/images/2016/04/Vorsteiner-BMW-M4-RACE-3.jpg" class="img-thumbnail tweetPicture">
               </div>
               <div class="panel-footer panel-footer-tweet">
                  <i class="fa fa-reply fa-2x tweetIcon" aria-hidden="true"></i> <label class="numberIcone">2</label>
                  <i class="fa fa-level-up fa-2x tweetIcon" aria-hidden="true"></i> <label class="numberIcone">1</label>
                  <i class="fa fa-heart fa-2x tweetIcon heart" aria-hidden="true"></i> <label class="numberIcone">3</label>
      ...
      <div class="col-md-11 rightSide">
         <div class="row">
            <div class="panel panel-default text-left rSide">
               <div class="panel-heading" id="panel-heading-tweet">
                  <a class="authorTweet"><strong>Toni Buzov</strong> <label class="timeTweet">@tonibuzov - 25 min</label></a>
                  <p class="textOfTweet">Mama najbolje kuha, MLJAC.</p>
               </div>
               <div class="panel-body panel-body-tweet">
                  <img src="http://cdn.finirecepti.com/wp-content/uploads/2015/10/palacinke-1.jpg" class="img-thumbnail tweetPicture">
               </div>
               <div class="panel-footer panel-footer-tweet">
                  <i class="fa fa-reply fa-2x tweetIcon" aria-hidden="true"></i> <label class="numberIcone">2</label>
                  <i class="fa fa-level-up fa-2x tweetIcon" aria-hidden="true"></i> <label class="numberIcone">1</label>
